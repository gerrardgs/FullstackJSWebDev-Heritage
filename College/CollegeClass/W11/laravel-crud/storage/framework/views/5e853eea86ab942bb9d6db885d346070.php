...
<div class="container pt-4 bg-white">
  <div class="row">
    <div class="col-md-8 col-xl-6">
      ...
      <form action="<?php echo e(route('mahasiswas.update',['mahasiswa' => $mahasiswa->id])); ?>"
      method="POST">
        ...
        <div class="mb-3">
          ...
          <div class="d-flex">
            <div class="form-check me-3">
              ...
              <?php echo e((old('jenis_kelamin') ?? $mahasiswa->jenis_kelamin)
              == 'L' ? 'checked': ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
          ...
          value="<?php echo e(old('jurusan')); ?>">
            ...
            <?php echo e((old('jurusan') ?? $mahasiswa->jurusan)==
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
          ...
          name="alamat"><?php echo e(old('alamat') ?? $mahasiswa->alamat); ?></textarea>
        </div>
...
<?php /**PATH E:\xAMPP\htdocs\laravel-crud\resources\views/mahasiswa/edit.blade.php ENDPATH**/ ?>